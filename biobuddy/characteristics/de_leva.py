...
def point_on_vector(coef: float, start: np.ndarray, end: np.ndarray) -> np.ndarray:
    # Same I expect local coordinates
...
class DeLevaTable:
    def __init__(self, total_mass: float, sex: Sex):
        ...
        # The folowing attributes will be set either by from_data or from_measurements
        ...
        self.inertial_table = {
            Sex.MALE: {
                SegmentName.HEAD: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.5002, start=self.top_head_position, end=self.shoulder_position),
                ...
                SegmentName.TRUNK: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: -point_on_vector(0.5138, start=self.shoulder_position, end=self.pelvis_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.UPPER_ARM: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.5772, start=self.shoulder_position, end=self.elbow_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.LOWER_ARM: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4574, start=self.elbow_position, end=self.wrist_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.HAND: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.7900, start=self.wrist_position, end=self.finger_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.THIGH: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4095, start=self.pelvis_position, end=self.knee_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.SHANK: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4459, start=self.knee_position, end=self.ankle_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.FOOT: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4415, start=self.ankle_position, end=self.toes_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
            ...
            Sex.FEMALE: {
                SegmentName.HEAD: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4841, start=self.top_head_position, end=self.shoulder_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.TRUNK: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: -point_on_vector(0.4964, start=self.shoulder_position, end=self.pelvis_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.UPPER_ARM: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.5754, start=self.shoulder_position, end=self.elbow_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.LOWER_ARM: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4559, start=self.elbow_position, end=self.wrist_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.HAND: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.7474, start=self.wrist_position, end=self.finger_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.THIGH: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.3612, start=self.pelvis_position, end=self.knee_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.SHANK: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4416, start=self.knee_position, end=self.ankle_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
                ...
                SegmentName.FOOT: InertiaParameters(
                    ...
                    center_of_mass=lambda m, bio: point_on_vector(0.4014, start=self.ankle_position, end=self.toes_position),
                    inertia=lambda m, bio: InertiaParameters.radii_of_gyration_to_inertia(
