...
def test_model_creation_from_static(brbd, remove_temporary: bool = True):
    ...
    bio_model.segments["UPPER_ARM"].add_marker(
        bmc.MarkerReal(name="SHOULDER", parent_name="UPPER_ARM", position=(0, 0, 0)))
    bio_model.segments["UPPER_ARM"].add_marker(
        bmc.MarkerReal(name="SHOULDER_X", parent_name="UPPER_ARM", position=(1, 0, 0)))
    bio_model.segments["UPPER_ARM"].add_marker(
        bmc.MarkerReal(name="SHOULDER_XY", parent_name="UPPER_ARM", position=(1, 1, 0)))
    ...
    bio_model.segments["LOWER_ARM"].add_marker(
        bmc.MarkerReal(name="ELBOW", parent_name="LOWER_ARM", position=(0, 0, 0)))
    bio_model.segments["LOWER_ARM"].add_marker(
        bmc.MarkerReal(name="ELBOW_Y", parent_name="LOWER_ARM", position=(0, 1, 0)))
    bio_model.segments["LOWER_ARM"].add_marker(
        bmc.MarkerReal(name="ELBOW_XY", parent_name="LOWER_ARM", position=(1, 1, 0)))
...
def test_complex_model(brbd, remove_temporary: bool = True):
    ...
    bio_model.segments["PENDULUM"] = bmc.Segment(
        ...
        qdot_ranges=bmc.RangeOfMotion(range_type=bmc.Ranges.Qdot, min_bound=[-10, -10, -10, -np.pi * 10],
