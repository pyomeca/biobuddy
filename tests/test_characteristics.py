...
def test_de_leva_table_mass_calculations():
    ...
    for segment in expected_male_masses.keys():
        ...
        npt.assert_almost_equal(
            male_table[segment].relative_mass(MOCK_DATA, BiomechanicalModel()),
            expected_male_masses[segment]
        )
        # Female
        npt.assert_almost_equal(
            female_table[segment].relative_mass(MOCK_DATA, BiomechanicalModel()),
            expected_female_masses[segment]
        )
    ...
    for segment in expected_male_com.keys():
        # Male
        npt.assert_almost_equal(
            male_table[segment].center_of_mass(MOCK_DATA, BiomechanicalModel()),
            expected_male_com[segment]
        )
        # Female
        npt.assert_almost_equal(
            female_table[segment].center_of_mass(MOCK_DATA, BiomechanicalModel()),
            expected_female_com[segment]
        )
